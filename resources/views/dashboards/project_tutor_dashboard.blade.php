...
<div class="container-fluid">
    <div class="card shadow-sm p-3 mb-4 bg-white">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
            <div>
                <h3 class="fw-bold mb-1">Project Tutor Dashboard</h3>
                <small class="text-muted">Reviewing project completion clearance requests</small>
            </div>
            <a href="{{ route('project.clearance.management') }}" class="btn btn-primary btn-sm">
                Open project clearance
            </a>
        </div>
    </div>
    ...
    <div class="card shadow-sm p-4 mb-4 bg-white">
        <h5 class="fw-semibold mb-1">Recent Project Clearance Updates</h5>
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle text-center">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-muted py-3">No processed project updates yet</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
