...
<div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
    ...
    <div class="d-flex gap-2">
        <a href="{{ $pendingList->previousPageUrl() ?: '#' }}"
           class="btn btn-outline-secondary btn-sm project-pending-page {{ $pendingList->onFirstPage() ? 'disabled' : '' }}"
        ...
        <a href="{{ $pendingList->hasMorePages() ? $pendingList->nextPageUrl() : '#' }}"
           class="btn btn-outline-secondary btn-sm project-pending-page {{ $pendingList->hasMorePages() ? '' : 'disabled' }}"
