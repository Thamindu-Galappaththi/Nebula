...
<div class="col-12">
    <label for="{{ $p }}course_content" class="form-label">Course Content <span class="text-danger">*</span></label>
    <textarea class="form-control" id="{{ $p }}course_content" name="course_content" rows="2" placeholder="Enter the course content" @if($req) required @endif></textarea>
</div>
<div class="col-12">
